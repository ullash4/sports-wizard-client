...
const Footer = () => {
  ...
  <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
    <div className="mr-12 hidden lg:block">
      <span>Get connected with SportsWizard on social networks:</span>
    </div>
    <div className="flex justify-center">
      <a href="https://web.facebook.com/BigBoyUllash" className="mr-6 text-gray-600">
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div className="">
        ...
        <p>
          Sports wizard a warehouse of sports related things or 
          sports equipments. We stock sports related products for our business. Stay connected with sports wizard. Peace
        </p>
      </div>
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Jersey</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Rackets</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Cricket Bats</a>
        </p>
        <p>
          <a href="#!" className="text-gray-600">Football</a>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
        ...
        <p className="mb-4">
          ...
          <Link to={'/inventory'} className="text-gray-600">Inventory</Link>
        </p>
        <p className="mb-4">
  ...
  <div className="text-center p-6 bg-gray-200">
    ...
    <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">SportsWizard</a>
  </div>
</footer>
        </div>
    );
